...
# download_dir = os.path.join(wd_path, 'planet_scenes', 'raw_additional')
...
order_name = 'Quesnel_8b_scenes_harmonized_clipped_coveragebyblock_0.1cloud_2013to2020'
