...
#----data preprocessing
{
  ...
  #----mask data using NTEMS forest cover mask (commented out, not recommended----
  ##this step removes a giant portion of pixels from each thinning block. Therefore, it's not recommended.
